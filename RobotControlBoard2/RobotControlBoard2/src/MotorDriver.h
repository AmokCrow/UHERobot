...
public:
    ...
    void init(uint8_t gpioPin1, uint8_t pin1TmrFunc, uint8_t gpioPin2, uint8_t pin2TmrFunc, volatile avr32_tc_t* timer, uint16_t timerChannel, uint16_t frequency, uint8_t dirInverted);
